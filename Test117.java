...
○ 중첩 클래스의 종류(4가지)
	...
	2. 내부 클래스(inner class)
		...
		알아보기 쉽도록 할 수 있다.
		-외부 클래스의 메소드애서 내부 멤버 클래스를 사용하기 위해서는
		...
		-static 으로 선언된 변수 또는 메소드를 가질수 없다.

	3. 지역 클래스(로컬 클래스, local class) -메소드 안
	...
	4. 익명 클래스(무명 클래스, anonymous class) - 이름x
		이름 없는 클래스
...
public class Test117
{
	public static void main(String[] args)
	{
		...
		//	 클래스 메소드를 호출하거나 클래스 변수에 접근 하는 것과 같은 방식을 통해
		//	 접근하여 인스턴스를 생성할 수 있도록 아래와 같이 처리해야 한다.

		System.out.println("a : " +Test.a);  //--==>a : 10
