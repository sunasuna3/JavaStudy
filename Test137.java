...
○ Calendar클래스 객체 (인스턴스)를 생성할 수 있는 방법

	1.Calendar ob1 = Calendar.getInstance();

	2.Calendar ob2 = new GregorianCalendar();  //업캐스팅

	3.GregorianCalendar ob3 = new GregorianCalendar();  //여기서 ob3의 타입은 GregorianCalendar 타입
...
public class Test137
{
	public static void main(String[] args) 
	{
		...
		*/
		...
		//달력의 날짜 세팅 -> 『set()』 메소드 활용   //월은 -1해서
		rigthNow2.set(2019,6,18);		//7월 check~!!
		
		System.out.println(rigthNow2.get(Calendar.DAY_OF_WEEK));
		//--==> 5 -> 목요일

		System.out.println(week2[rigthNow2.get(Calendar.DAY_OF_WEEK)-1]);  //배열 0 이 일요일이니까

		rigthNow2.set(1995,10,13);  //1995년 11월 13일~~~~
