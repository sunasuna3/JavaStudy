...
public class Test092
{
	...
	void write()	//--instance 메소드(인스턴스 메소드)
	{
		...
		System.out.println("인스턴스 변수 b : "+b);  //--여기서는 에러 발생 x
	}
	...
	{
		System.out.println("클래스 변수 a : "+a);
		//System.out.println("인스턴스 변수 b : "+b);  //--에러발생 
	}
	...
	public static void main(String[] args)
	{
		...
		//System.out.println("main() -> 클래스 변수 b : " + Test092.b);  -- 컴파일 에러
		//System.out.println("main() -> 클래스 변수 b : " + b);   --컴파일 에러

		//write(); //인스턴스 메소드  -> non-static method write() 
		//Test092.write();  -> non-static method write() 
		...
		ob1.write();
		ob1.print();
		//--==>>클래스 변수 a : 1000  //ex스테이플러생각하자
		//		인스턴스 변수 b : 20  //ex딱풀생각하자
		//		클래스 변수 a : 1000
