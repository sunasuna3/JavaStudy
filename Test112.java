...
○ 인터페이스는 상수와 추상 메소드만 가질 수 있으며
   인터페이스 안의 메소들을 접근제어지시자를 명시하지 않아도
...
○ 특징
   ...
   - 인터페이스는 『public static final』 상수만 만들수 있다.
...
interface Demo
{
	...
	//인스페이스 멤버 변수는 『static final』을 별로도 명시하여 붙이지 않아도
	...
	public void print()
	{
		System.out.print("인터페이스 print() 메소드...");
	}
	*/
...
public class Test112
{
	public static void main(String[] args)
	{
		...
		//DemoImpl obTemp = new DemoImpl();   +   Demo ob =(Demo)obTemp;
		ob.print();
		//--==>인터페이스 메소드 재정의...
