...
○ Hashtable<K,V>클래스
	...
	- 또한, Hashtable 클래스는 key 또는 value 의 값을 null을 허용하지 않는다.
*/
...
public class Test164
{
	...
	public static void main(String[] args)
	{
		...
		//ht 라는 해시테이블의 요소 중 값을... key를 이용하여 검색
		String findName1="김정규";
		//String findName1="유진석";
		String str =ht.get(findName1);		// get(키) -> 값  여태까지는 get(인덱스)
		if (str != null)
		{
		...
		//ht라는 해시테이블 자료구조에...value 가 존재하는지의 여부 확인
		//-> contains()
		...
		{
			System.out.println("재준이가 존재합니다.");
		}
		else
			System.out.println("재준이 어디갔어?");
		System.out.println();
		//--==> 재준이 어디갔어?
		...
		{
			System.out.println("010-9118-5974 가 존재합니다.");
		}
		else
			System.out.println("010-9118-5974 가 존재하지 않습니다.");

		System.out.println();
		//--==> 010-9118-5974 가 존재하지 않습니다.
		//key 제거 ->value 도 제거!!!
		

		//null 입력 시도
		//ht.put(null,null);		//--key, value  모두 null   -> (X)
		//ht.put("조현우",null);		// value 가 null  -> (X)
		//ht.put(null,"010-2222-2222");   // key 가 null  -> (X)
