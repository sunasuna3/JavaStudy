...
○ import 문
	...
	※ JDK1.5 부터는 import 다음에 『static』 키워드를 붙임으로써
...
public class Test121 //extends Object 
{
	...
	*/
	...
	public static void main(String[] args)
	{
		...
		//임의로생성된객체.xxx();  //--대상 클래스가 갖고 있는 메소드 xxx() 호출
		//--해당 객체를 생성시키는 대상 클래스의 메소드

		//ob.test();
		//--==> 에러 발생
		//--해당 클래스에 test() 라는 메소드가 정의되어 있지 않기 떄문에...

		//System.out.println(ob.action());
		//--==> 에러 발생
		//--해당 클래스에 action() 라는 메소드가 정의되어 있지 않기 떄문에...
