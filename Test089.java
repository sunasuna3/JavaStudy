...
public class Test089
{
	public static void main(String[] args)
	{
		...
		//테스트
		//System.out.println("발생한 난수 :" + rd.nextInt(100));//0~99까지의 난수 발생
		...
		{
			arr[i] = rd.nextInt(100)+1;  //0~99까지 +1 = 1~100 사이의 난수 중 1개 발생~~!!
